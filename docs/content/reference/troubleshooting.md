...
Most of these come down to network reality or how snapchat serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

snapchat rate-limits like any public site. snap already paces
...
Where a surface is gated, snap reads a cookie or token you supply
...
`snap`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what snap actually did
